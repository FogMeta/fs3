...
const minio = () =>
  import ("@/views/minio/index");
const login = () =>
  import ("@/components/login");

const fs3_backup = () =>
  import ("@/components/fs3Backup");

const my_account = () =>
  import ("@/views/myAccount/index");
const my_account_dashboard = () =>
  import ("@/views/myAccount/dashboard/index");
const my_account_dashboard_detail = () =>
  import ("@/views/myAccount/dashboard/details");
const backupPlans = () =>
  import ("@/views/myAccount/backupPlans/index");
const myPlans = () =>
  import ("@/views/myAccount/myPlans/index");
const myJobs = () =>
  import ("@/views/myAccount/myJobs/index");
const my_archives = () =>
  import ("@/views/myAccount/archives/index");
      ...
      children: [{
        ...
        },
        {
          ...
          children: [{
            ...
            {
              path: '/my_archives/:name',
              name: 'my_archives',
              component: my_archives
            }
          ]
        },
      ]

<template>
    <div class="wrapper" @click="wrapperClick">
        <v-slide :class="{'sliMobile': slideShow}" :minioListBuckets="minioListBuckets" :currentBucket="currentBucket" :homeClick="homeClick" @homeClickFun="homeClickFun" @getshareHome="getshareHome" @getretrievalHome="getretrievalHome" @getminioListBucket="getminioListBucket"
            @getListBuckets="getListBuckets" @getMenuStretch="getMenuStretch"></v-slide>
        <div class="content" :class="{'content_stretch': menuStretch}">
            ...
            <transition name="move" mode="out-in">
                <router-view :aboutServer="aboutServer" :aboutListObjects="aboutListObjects" :minioListBuckets="minioListBuckets" :slideListClick="slideListClick" :addFileClick="addFileClick" :uploadClick="uploadClick" :dialogFormVisible="dialogFormVisible"
                    :currentBucket="currentBucket" :userd="userd" :allDealShow="allDealShow" @getDialogClose="getDialogClose" @getaboutServer="getMakeBucket" @getRemoveObject="getRemoveObject" @getListObjects="getListObjects"></router-view>
            </transition>
            <div class="addFile">
                <el-row v-if="addFileShow">
                    <el-col :span="24">
                        <el-upload class="upload-demo" action="customize" ref="uploadFile" :http-request="httpRequest" :on-change="onChange" multiple :auto-upload="false">
        ...
        <share-dialog v-if="isRouterAlive" :shareDialog="shareDialog" :shareObjectShow="shareObjectShow" :shareFileShow="shareFileShow" :postAdress="currentBucket" :sendApi="sendApi" @getshareDialog="getshareDialog">
        </share-dialog>

        <retrieval-dialog :retrievalDialog="retrievalDialog" :currentBucket="currentBucket" @getretrievalDialog="getretrievalDialog">
        </retrieval-dialog>
    </div>
</template>

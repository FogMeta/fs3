        ...
        <el-row class="share_right" v-if="shareFileShow && activeOn == 'online'">
          ...
          <el-col :span="24">
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="130px" class="demo-ruleForm">
              <el-form-item label="Provider Region:" prop="minerId" v-if="activeOn == 'online'">
                <el-select v-model="ruleForm.region" placeholder="">
                  <el-option v-for="item in locationOptions" :key="item.value" :label="item.value" :value="item.value">
                  </el-option>
                </el-select>
              </el-form-item>
              ...
              <el-form-item label="Fast-Retrieval:" prop="fastRetirval">
          ...
          <el-col :span="24">
            <el-form :model="offlineForm" :rules="ruleOfflines" ref="offlineForm" label-width="115px" class="demo-ruleForm">
              ...
              <el-form-item label="Tags:" prop="tags">
                ...
                <el-input class="input-new-tag" v-if="inputVisibleTask" v-model="inputValueTask" ref="saveTagInput" size="small" @blur="handleInputConfirmTask" @keyup.enter.native="handleInputConfirmTask" maxlength="15">
                </el-input>
              ...
              <el-form-item prop="bidDay" v-if="offlineForm.OpenBidType == 1">
                <h4 style="margin: 0px 0px 0px -75px;color: #606266;font-size: 14px;">Expect Complete in
                  <el-input v-model="offlineForm.bidDay" style="width:60px"></el-input> days.</h4>
              </el-form-item>
    ...
    submitForm (formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          if (_this.sendApi == 1) {
            postUrl = _this.data_api + `/minio/backup/` + _this.postAdress
          } else {
              ...
              .el-col {
                ...
                .el-input-number {
                  ...
                  .el-input-number__decrease {
                    background: transparent url(../assets/images/down.png)
                      no-repeat center;
                  ...
                  .el-input-number__increase {
                    bottom: auto;
                    background: transparent url(../assets/images/up.png)
                      no-repeat center;
                    background-size: auto 100%;
                    height: 20px;
                    top: 0;

  ...
  <div class="fs3_back">
    <div class="fs3_head">
      <div class="fs3_head_text">
        <div class="titleBg">Archives</div>
        <h1>Archives</h1>
      </div>
...
export default {
  ...
  methods: {
    ...
    rebuildAction (row) {
      ...
      let paramsRebuild = {
        "backup_id": row.id,
        "object": _this.$route.params.name
      }
    ...
    getData (type) {
      let _this = this
      _this.loading = true
      let postUrl = _this.data_api + `/minio/archives/${_this.$route.params.name}`
      let offsetRebuild = _this.parma.offset > 0 ? _this.parma.offset - 1 : 0
      let paramsRebuild = {

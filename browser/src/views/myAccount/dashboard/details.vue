<template>
  <div class="fs3_back">
    ...
    <div class="fs3_cont">
      ...
      <el-table :data="tableData" v-loading="loading" stripe empty-text="No data" v-if="$route.params.type == 'backup_job'">
    ...
    <div class="form_pagination" v-else>
      <div class="pagination">
        <el-pagination hide-on-single-page :total="parmaRebuild.total" :page-size="parmaRebuild.limit" :current-page="parmaRebuild.offset" :pager-count="bodyWidth ? 5 : 7" background :layout="
              bodyWidth
                ? 'prev, pager, next'
                : 'total, prev, pager, next, jumper'
    ...
    <el-dialog title="Rebuild Image" custom-class="formStyle" :visible.sync="dialogConfirm" :width="dialogWidth">
    ...
    <el-dialog title="Rebuild Image" custom-class="formStyle" :visible.sync="dialogDis" :width="dialogWidth">

<template>
  <div class="fs3_back">
      ...
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" class="demo-ruleForm" v-loading="loading">
        ...
        <el-form-item label="Choose your backup frequency:" prop="frequency">
          <el-select v-model="ruleForm.frequency" placeholder="">
            <el-option v-for="item in ruleForm.frequencyOptions" :key="item.value" :label="item.label" :value="item.value">
            </el-option>
          </el-select>
        </el-form-item>
    ...
    <el-dialog :title="ruleForm.name" custom-class="formStyle" :visible.sync="dialogVisible" :width="dialogWidth">
      <el-card class="box-card">
        <div class="statusStyle">
          <div class="list">
            <span>Backup frequency:</span> {{ruleForm.frequency == '1'?'Backup Daily':'Backup Weekly'}}</div>
          <!-- <div class="list"><span>Backup region:</span> {{ruleForm.region}}</div> -->
          <div class="list">
            <span>Duration:</span> {{ruleForm.duration}} days</div>
          <div class="list">
            <span>Verified deal:</span> {{ruleForm.verified == '2'? 'No' : 'Yes'}}</div>
          <div class="list">
            <span>Fast retrieval:</span> {{ruleForm.fastRetirval == '2'? 'No' : 'Yes'}}</div>
        </div>
      </el-card>
    ...
    <el-dialog title="Backup Plans" custom-class="formStyle" :visible.sync="dialogConfirm" :width="dialogWidth">
